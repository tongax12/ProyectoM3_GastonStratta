 ...
 */
import { CHARACTERS, characterAvatarHTML, wireAvatarImages } from '../characters.js';
      ...
      <div class="about-grid">
        <article class="about-card">
          ...
          <ul class="about-list">
            ...
            <li><strong>JavaScript con ES Modules</strong>: router propio sobre <code>pushState</code>/<code>popstate</code>.</li>
            <li>Sin frameworks ni build step: abrir y funcionar.</li>
          </ul>
        </article>
